...
namespace HID_Report_Descriptor_Editor.Utils
{
    public static class NativeMethods
    {
        ...
        /// </summary>
        /// <param name="wEventId">Describes the event that has occurred. Typically, only one event is specified at a time.</param>
        /// <param name="uFlags">Flags that, when combined bitwise with <see cref="HChangeNotifyFlags"/>, 
        /// indicate the meaning of the <i>dwItem1</i> and <i>dwItem2</i> parameters.</param>
        /// <param name="dwItem1"><b>Optional</b>. First event-dependent value.</param>
        /// <param name="dwItem2"><b>Optional</b>. Second event-dependent value.</param>
